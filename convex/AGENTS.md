...
├── googleCalendar/  # queries.ts, mutations.ts, actionsNode.ts, http.ts, syncWorkflow.ts
├── eventTaskLinks/  # queries.ts, mutations.ts, *.test.ts
└── taskProviders/
    └── linear/     # queries.ts, mutations.ts, actionsNode.ts, syncWorkflow.ts
```
...
- [docs/workflows.md](docs/workflows.md) (Google Calendar sync uses `@convex-dev/workflow`; workflow state kept small)
