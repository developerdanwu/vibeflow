...
import {
	ZCalendarDragData,
	ZTimeBlockOverData,
} from "@/routes/_authenticated/calendar/-components/big-calendar/components/dnd/dnd-schemas";
import { DropRangeRing } from "@/routes/_authenticated/calendar/-components/big-calendar/components/dnd/drop-range-ring";
import { DroppableTimeBlock } from "@/routes/_authenticated/calendar/-components/big-calendar/components/dnd/droppable-time-block";
import { eventBadgeVariants } from "@/routes/_authenticated/calendar/-components/big-calendar/components/month-view/month-event-badge";
import { CalendarTimeline } from "@/routes/_authenticated/calendar/-components/big-calendar/components/week-and-day-view/calendar-time-line";
import { EventBlock } from "@/routes/_authenticated/calendar/-components/big-calendar/components/week-and-day-view/event-block";
import { useCalendar } from "@/routes/_authenticated/calendar/-components/big-calendar/contexts/calendar-context";
import {
	getEventBlockStyle,
	isWorkingHour,
} from "@/routes/_authenticated/calendar/-components/big-calendar/core/helpers";
import type { TEvent } from "@/routes/_authenticated/calendar/-components/big-calendar/core/interfaces";
import { useDragToCreate } from "@/routes/_authenticated/calendar/-components/big-calendar/hooks/use-drag-to-create";
