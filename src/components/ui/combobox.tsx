...
function ComboboxContent({
	...
	> & {
		/** Width behavior: "anchor" matches trigger width, "min" uses min-width allowing growth, or a specific width like "w-80" */
		width?: "anchor" | "min" | string;
	}) {
	return (
			...
			>
				<ComboboxPrimitive.Popup
					...
					className={cn(
						...
						width === "min" && "min-w-(--anchor-width)",
						typeof width === "string" && width !== "anchor" && width !== "min" && width,
						className,
					)}
					{...props}
				/>
