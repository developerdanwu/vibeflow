...
function PopoverContent({
	...
	const closedAnimationClasses = animateOut
	...
	return (
		<PopoverPrimitive.Portal>
			{backdrop && (
				<PopoverPrimitive.Backdrop className={"fixed inset-0 isolate z-50"} />
			)}
